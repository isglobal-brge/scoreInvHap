...
```{r, classify EUR, cache=TRUE}
res <- classifierPipeline(SNPlist = EUR, SNPsR2 = SNPsR2$ROIno.8.3, hetRefs = hetRefs$ROIno.8.3, 
                          Refs = Refs$ROIno.8.3, alfreq = globalFreqs$ROIno.8.3, 
                          genofreq = genoFreqs$ROIno.8.3)
res
```
...
```{r, classify all, cache=TRUE}
resAll <- classifierPipeline(SNPlist = snpsVCF, SNPsR2 = SNPsR2$ROIno.8.3, 
                             hetRefs = hetRefs$ROIno.8.3, Refs = Refs$ROIno.8.3, 
                             alfreq = globalFreqs$ROIno.8.3, 
                          genofreq = genoFreqs$ROIno.8.3,
                             R2 = 0, mc.cores = 10)
resAll
```
